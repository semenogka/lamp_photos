...
func main() {
	...
	for i := 1; i <= pages; i++ {
		...
		page := fmt.Sprintf("https://divinare.ru/catalog/podsvetki/page_%d", i)
		err := c.Visit(page)
	...
	saveToJson("alldata\\data\\podsvet.json", products)
}
